            ...
            <?php if (isset($_POST['submit'])) {
                ...
                <div class="row">
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td><input type="checkbox" class="larger" name="seat[]" value="I9" <?php
                                                    ...
                                                    ?>></td>
                                                <td><input type="checkbox" class="larger" name="seat[]"
                                                           value="I10" <?php
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-7">
                                    <div class="seattable" id="gold">
                                        <table>
                                            ...
                                            <tr>
                                                <td class="line" style="width: 10%;color:white;">
                    ...
                    <div class="col-lg-6">
                        ...
                        <table>
                            <tr>
                                <td width="50%"><font color="blue" size="5px" style="font-family: Shruti;">Movie:</font>
                                </td>
                                <td bgcolor="79F9E2">
                                    <center><font size=5
                                                  style="font-family: Shruti; "><?php echo $_GET['movie']; ?></font>
                                    </center>
                                </td>
                            </tr>
                            <tr>
                                <td width="50%"><font color="blue" size="5px" style="font-family: Shruti;">Time:</font>
                                </td>
                                <td bgcolor="ECF68C">
                                    <center><font size=5
                                                  style="font-family: Shruti;"><?php echo $_GET['time']; ?></font>
                                    </center>
                                </td>
                            </tr>
                            <tr>
                                <td width="50%"><font color="blue" size="5px" style="font-family: Shruti;">Seat:</font>
                                </td>
                                <td><input type="text" id="selectedtext" name="seats" placeholder="selected checkboxs">
                                </td>
                            </tr>
                            <tr>
                                <td width="50%"><font color="blue" size="5px" style="font-family: Shruti;">Total
                                        Seat:</font></td>
