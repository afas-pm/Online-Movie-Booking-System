...
if (mysqli_num_rows($result) > 0) {
  while($row = mysqli_fetch_array($result)) {
    ...
    <tr>
              ...
              <td><?php echo $row['show_from_date'];?></td>
	      <td><?php echo $row['show_to_date'];?></td>
	      <td><?php echo $row['book_to'];?></td>
      ...
      <div class="modal-body">
        <form id="insert_movie" action="insert_data.php" method="post" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="col-12">
              <div class="form-group">
                <label>Show_from_date</label>
                <input type="date" name="edit_Show_from_date" id="edit_Show_from_date class="form-control" value="<?php echo $row['show_from_date'];?>">
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
                <label>Show_to_date</label>
                <input type="date" name="edit_Show_to_date" id="edit_Show_to_date class="form-control" value="<?php echo $row['show_to_date'];?>">
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
                <label>book_to</label>
                <input type="number" name="edit_book_to" id="edit_book_to" class="form-control" value="<?php echo $row['book_to'];?>">
              </div>
            </div>
             <div class="col-12">
              <div class="form-group">
                <label>Trailer</label>
                <input class="form-control" name="edit_trailer" id="edit_trailer" class="form-control" value="<?php echo $row['you_tube_link'];?>">
              </div>
            </div>
             <div class="col-12">
              <div class="form-group">
      ...
      <div class="modal-body">
        <form name="myform" id="insert_movie" action="insert_data.php" method="post" enctype="multipart/form-data" onsubmit="return validateform()" >
            ...
            <div class="col-12">
              <div class="form-group">
                <label>Show_from_date</label>
                <input type="date" name="show_from_date" id="show_from_date" class="form-control" placeholder="Enter Show From Date" required>
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
                <label>Show_to_date</label>
                <input type="date" name="show_to_date" id="show_to_date" class="form-control" placeholder="Enter Show to Date" required>
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
                <label>book_to</label>
                <input type="number" name="book_to_date" id="book_to" class="form-control" placeholder="Enter book to Date" required>
              </div>
            </div>
