                    ...
                    <div class="tab-content">
                        ...
                        <div id="credit-card" class="tab-pane fade show active pt-3">
                            ...
                            <div class="form-group"><label for="username">
                                    <h6>Card Owner</h6>
                                </label> <input type="text" id="card_name" name="card_name"
                            ...
                            <div class="form-group"><label for="cardNumber">
                                ...
                                <div class="input-group"><input type="text" id="card_number" name="card_number"
                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    <div class="form-group"><label><span class="hidden-xs">
                                        ...
                                        <div class="input-group"><input type="date" id="ex_date" placeholder="MM"
                                                                        name="ex_date" class="form-control">
                                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#payment").click(function () {
            ...
            if (card_name == '') {
                error = " <font color='red'>!Invalid User.</font> ";
                document.getElementById("validatecardname").innerHTML = error;
                return false;
            }
            if (card_number == '') {
                error = " <font color='red'>!Invalid Number.</font> ";
                document.getElementById("validatecardnumber").innerHTML = error;
                return false;
            }
            if (ex_date == '') {
                error = " <font color='red'>!Invalid Date.</font> ";
